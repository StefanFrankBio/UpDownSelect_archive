...
model           = 2                * models for codons: 0:one, 1:b, 2:2 or more dN/dS ratios for branches, models for AAs or codon-translated AAs: 0:poisson, 1:proportional,2:Empirical,3:Empirical+F, 5:FromCodon0, 6:FromCodon1, 8:REVaa_0, 9:REVaa(nr=189)
